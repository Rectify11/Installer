...
namespace Rectify11Installer.Pages
{
	public partial class ProgressPage : WizardPage
	{
		...
		{
            new("Rectify11 has changed everything", "We have modernized many icons in many different system files, resulting in a more consistent and fluent user experience.", Properties.Resources.tree),
            ...
            new("Thank you!", "We appreciate your support, thank you for installing Rectify11.", Properties.Resources.halal)
        };
		#endregion
		#region Classes
