...
var monthArrayLong = new Array('enero', 'febero', 'marzo', 'abril', 'mayo', 'junio', 'julio', 'agosto', 'septiembre', 'octubre', 'noviembre', 'diciembre');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  html += "<button class='dpTodayButton' onClick='updateDateField(\"" + dateFieldName + "\");'>cierre</button>";
  html += xTD + xTR;
