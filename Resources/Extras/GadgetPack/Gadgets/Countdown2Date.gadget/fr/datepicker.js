...
var monthArrayShort = new Array('Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Aoû', 'Sep', 'Oct', 'Nov', 'Déc');
var monthArrayMed = new Array('Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Aoû', 'Sep', 'Oct', 'Nov', 'Déc');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  html += "<button class='dpTodayButton' onClick='updateDateField(\"" + dateFieldName + "\");'>fin</button>";
  html += xTD + xTR;
